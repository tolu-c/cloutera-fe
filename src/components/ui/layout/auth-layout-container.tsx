...
const AuthLayoutContainer = ({ children }: AuthLayoutContainerProps) => {
  return (
    <div className="grid min-h-screen w-full grid-cols-1 content-center p-5 lg:grid-cols-2">
      <div className="rounded-30 bg-cloutera-black relative hidden h-full w-full flex-col items-start justify-between overflow-hidden p-15 lg:flex">
